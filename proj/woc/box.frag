...
void main()
{
	...
	//finalColor+=CalcLightSpot(lightSpot[0],uNormal,dirToCamera);

	//finalColor+=CalcLightDirectional(lightDirectional[0],uNormal,dirToCamera);
	//finalColor+=CalcLightDirectional(light,uNormal,dirToCamera);
