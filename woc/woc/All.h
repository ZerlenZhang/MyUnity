...
public:
	...
	LightType Type()const override { return Directional; }
...
public:
	...
	LightType Type()const override { return Point; }
...
public:
	...
	LightType Type()const override { return Spot; }
...
public:
	...
	virtual void Use(mat4& view, mat4& proj, mat4 model = mat4(1.0f), float skininess = 1.0f);
};
#pragma endregion
...
public:
	...
	void Use(mat4& view, mat4& proj, mat4 model = mat4(1.0f), float skininess = 1.0f)override;
};
